...
public interface ResponseMessage {
  ...
  interface Message {
    ...
    String ERROR_PARAM_EXISTS = "Error parameter already exists";
    String INVALID_TENANT_SECURITY_LEVEL_LOWER = "Tenant security level cannot be lower than existing level";
    String INVALID_SECURITY_LEVEL = "Invalid security level";
  ...
  interface Key {
    ...
    String INVALID_ENCRYPTION_FILE = "INVALID_ENCRYPTION_FILE";
    String RECOVERY_PARAM_MATCH_EXCEPTION = "RECOVERY_PARAM_MATCH_EXCEPTION";
    String ERROR_PARAM_EXISTS = "ERROR_PARAM_EXISTS";
    String INVALID_TENANT_SECURITY_LEVEL_LOWER = "INVALID_TENANT_SECURITY_LEVEL_LOWER";
    String INVALID_SECURITY_LEVEL = "INVALID_SECURITY_LEVEL";
    String INVALID_SECURITY_LEVEL_LOWER = "INVALID_SECURITY_LEVEL_LOWER";
    String DEFAULT_SECURITY_LEVEL_CONFIG_MISSING = "DEFAULT_SECURITY_LEVEL_CONFIG_MISSING";
    String DECLARED_USER_VALIDATED_STATUS_NOT_UPDATED = "DECLARED_USER_VALIDATED_STATUS_NOT_UPDATED";
    ...
    String EXTERNAL_ID_FORMAT_ERROR = "EXTERNAL_ID_FORMAT_ERROR";
    String USER_TYPE_CONFIG_IS_EMPTY = "USER_TYPE_CONFIG_IS_EMPTY";
    ...
    String MANAGED_BY_NOT_ALLOWED_ERROR = "MANAGED_BY_NOT_ALLOWED_ERROR"; // Fallback if Key.MANAGED_BY_NOT_ALLOWED is confusing
    // Wait, I should add MANAGED_BY_NOT_ALLOWED to Key interface (above chunk) and Message interface (some messages missing)
