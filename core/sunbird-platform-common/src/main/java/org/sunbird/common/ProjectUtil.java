...
public class ProjectUtil {
  ...
  /**
   * Sets trace ID in the header map from RequestContext.
   *
   * @param headerMap Map of headers
   * @param context RequestContext containing trace ID
   */
  public static void setTraceIdInHeader(Map<String, String> headerMap, org.sunbird.request.RequestContext context) {
    if (context != null && StringUtils.isNotBlank(context.getReqId())) {
      headerMap.put(JsonKey.X_TRACE_ID, context.getReqId());
    }
  }
